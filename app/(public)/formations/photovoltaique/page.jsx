...
export const metadata = {
  ...
  description: 'Stage 2 jours pour être plus autonome en énergie. Par Sébastien Deroo. Saint-Simeux, Charente (16).',
}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="bg-[#6a8e9a]/90 py-20 px-6 text-center">
          ...
          <Link href="/contact" className="btn-terracotta mt-6 inline-block">Je m&apos;inscris</Link>
        </div>
        ...
        <div className="bg-white/95 py-14 px-6">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-5">
              {[
                { t: 'Formateur', v: 'Sébastien Deroo, praticien de l'autonomie énergétique.' },
                { t: 'Public visé', v: 'Particuliers souhaitant une installation hors réseau ou hybride, auto-constructeurs.' },
                { t: 'Lieu', v: '21, rue des Chaumes — 16120 Saint-Simeux (Charente)' },
              ...
              <Link href="/contact" className="btn-terracotta inline-block mt-2">Nous contacter</Link>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#3d1a0e] py-10 px-6 text-center">
          <p className="font-raleway font-bold text-[10px] tracking-[0.2em] uppercase text-white/40 mb-5">Toutes les formations</p>
