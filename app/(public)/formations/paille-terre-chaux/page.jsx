...
export const metadata = {
  ...
  description: 'Stage 6 jours pour apprendre à construire, rénover et isoler avec de la paille, de la terre et de la chaux. André de Bouter, Saint-Simeux (16). 660 €.',
}

const IMG_BG    = 'https://static.wixstatic.com/media/3e33e8_c7ce8044bc594a609f7c72f370d79c9c~mv2.jpg/v1/fill/w_1240,h_1748,al_c,q_90,enc_avif,quality_auto/3e33e8_c7ce8044bc594a609f7c72f370d79c9c~mv2.jpg'
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="relative overflow-hidden" style={{ maxHeight: '60vh' }}>
          <Image src={IMG_BG} alt="Paille Terre Chaux" width={1240} height={700}
          ...
          <div className="absolute inset-0 bg-[#c8a040]/70 flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="font-raleway font-bold text-white uppercase mt-3"
               style={{ fontSize: '0.6rem', letterSpacing: '0.2em', textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
        ...
        <div className="bg-white/95 py-12 px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-raleway font-black text-[#3d1a0e] uppercase tracking-[0.08em] text-2xl mb-4">
              Les clés pour réaliser un projet durable, performant et confortable
            </h2>
            <p className="text-sm text-[#4a4a4a] leading-relaxed">
              Ce stage pratique, que j&apos;anime depuis 25 ans, est conçu pour passer une semaine passionnante ensemble,
              vous permettant d&apos;acquérir les compréhensions et compétences nécessaires pour la conception
              et réalisation de votre projet.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex gap-3 text-sm text-[#4a4a4a] leading-relaxed">
                    <span className="text-[#8b3a2a] font-bold flex-shrink-0 mt-0.5">—</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-8">
              <div>
                ...
                {['12 – 17 Avril', '10 – 15 Mai', '12 – 17 Juillet', '16 – 21 Août'].map((d) => (
                  <div key={d} className="flex items-center justify-between border-b border-[#f0e8d8] py-2">
                    <span className="font-raleway font-bold text-sm text-[#3d1a0e]">{d} 2026</span>
                ...
                <p className="text-xs text-[#4a4a4a] mt-3">
                  Horaires 9h–18h &nbsp;·&nbsp; Tarif <strong>660 €</strong> &nbsp;·&nbsp; Formateur : André de Bouter
                </p>
              </div>
              {[
                { t: 'Pré-requis', v: "Accessible à tous : particuliers et professionnels, bricoleurs et néophytes." },
                { t: 'Lieu', v: "21 rue des Chaumes — 16120 SAINT-SIMEUX" },
                { t: 'Hébergement', v: "Terrain pour camper, dortoir, parking van. Arrivée possible la veille 19h–22h." },
              ].map(({ t, v }) => (
                <div key={t}>
                  <h3 className="font-raleway font-black text-[#3d1a0e] uppercase tracking-[0.12em] text-xs mb-1">{t}</h3>
                  <p className="text-xs text-[#4a4a4a] leading-relaxed">{v}</p>
                </div>
              ))}
              <Link href="/contact" className="btn-terracotta inline-block">Je m&apos;inscris</Link>
            </div>
          </div>
        </div>
